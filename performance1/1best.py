...
files_and_tickers = [
    ('1strategy_performance_NVDA.csv', 'NVDA'),
    ('1strategy_performance_TSLA.csv', 'TSLA'),
    ('1strategy_performance_AAPL.csv', 'AAPL'),
    ('1strategy_performance_ACMR.csv', 'ACMR'),
    ('1strategy_performance_AMD.csv', 'AMD'),
    ('1strategy_performance_CRM.csv', 'CRM'),
    ('1strategy_performance_DBX.csv', 'DBX'),
    ('1strategy_performance_MSFT.csv', 'MSFT'),
    ('1strategy_performance_PANW.csv', 'PANW'),
    ('1strategy_performance_SMCI.csv', 'SMCI'),
]
...
best_csv_file_path = os.path.join(current_directory, '1best.csv')

# Write the combined results to the new CSV file
combined_results.to_csv(best_csv_file_path, index=False)

print("The best strategy statistics from all tickers have been saved to '1best.csv'")
