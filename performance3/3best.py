...
files_and_tickers = [
    ('3strategy_performance_NVDA.csv', 'NVDA'),
    ('3strategy_performance_TSLA.csv', 'TSLA'),
    ('3strategy_performance_AAPL.csv', 'AAPL'),
    ('3strategy_performance_ARM.csv', 'ARM'),
    ('3strategy_performance_AMD.csv', 'AMD'),
    ('3strategy_performance_CRM.csv', 'CRM'),
    ('3strategy_performance_DBX.csv', 'DBX'),
    ('3strategy_performance_MSFT.csv', 'MSFT'),
    ('3strategy_performance_PANW.csv', 'PANW'),
    ('3strategy_performance_SMCI.csv', 'SMCI'),
]
...
best_csv_file_path = os.path.join(current_directory, '3best.csv')

# Write the combined results to the new CSV file
combined_results.to_csv(best_csv_file_path, index=False)

print("The best strategy statistics from all tickers have been saved to '3best.csv'")
