...
if __name__ == '__main__':
    ...
    performance_folder = 'performance1'
    ...
    for security in securities:
        ...
        # CSV setup
        csv_file = os.path.join(performance_folder, f'1strategy_performance_{security}.csv')
        ...
        if best_strat is not None:
            ...
            print('---------------------------------------------------------------')
            print(f'Best Strategy Parameters for {security} - Lookback: {best_strat.params.lookback}, Exit After: {best_strat.params.exit_after}, Stop Loss: {best_strat.params.stop_loss}, Take Profit: {best_strat.params.take_profit}')
